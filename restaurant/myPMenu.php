...
if(isset($_GET['PmenuId'])){
  $PmenuId=$_GET['PmenuId'];
  $_SESSION['PmenuId']=$PmenuId;
}
?>
...
$sql="select mealName,mealimage,proposedTitle,mealPrice from proposedmenu p,meals m,mealname mn
where p.menuId=m.Pmenuid and m.mealNid=mn.mealNid and p.menuId=$PmenuId"; 
...
?>
  ...
  <div class="container-fluid text-center mt-5">
     <a class="btn btn-primary w-50 mx-auto" href="addMeal.php">Add new meal</a>
  </div>
